              ...
              <table>
                ...
                <tbody>
                  ...
                  foreach($call as $key => $val)
                  {
                    ...
                    echo "<td>".$val['times_set']."</td>";


                    

                   ?>               
                   <td><span><button name="edit" class="btn bg-primary  rounded-pill  text-white" ><a href="apportment_update_form.php?uid=<?php echo $val['id']; ?>"><i class="fa fa-pencil text-white"></i></a></button></span></td>
                   <td><span><button name="edit" class="btn bg-danger  rounded-pill  text-white"><a href="apportment_delete.php?uid=<?php echo $val['id']; ?>"><i class="fa fa-trash text-white"></i></a></button></span></td>
                   <?php
                   echo "</tr>";
                  }
                  ?>
