              ...
              <table>
                ...
                <tbody>
                  ...
                  foreach($call as $key => $val)
                  {
                    ...
                    echo "<td>".$val['subtitle']."</td>";
                    echo "<td>".$val['status']."</td>";

                   ?>    
                   <td><img src="<?php echo '../assects/slider/'.$val['image']; ?>" width="50px;"></td>           
                   <td><span><button name="edit" class="btn bg-primary  rounded-pill  text-white" ><a href="banner_update_form.php?uid=<?php echo $val['id']; ?> "><i class="fa fa-pencil text-white"></i></a></button></span></td>
                   <td><span><button name="edit" class="btn bg-danger  rounded-pill  text-white"><a href="banner_delete.php?uid=<?php echo $val['id']; ?>"><i class="fa fa-trash text-white"></i></a></button></span></td>
                   <?php
                   echo "</tr>";
                  }
                  ?>
