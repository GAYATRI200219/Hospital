   ...
   <?php
    ...
    <div class="row px-4 mt-3 ">
            <div class="col-md-12 main_form pb-5">
            	<h4 class=" p-2 text-center">bannetr Edit</h4>
                <div class="row">          
                    <div class="col-md-6 mt-3 mx-auto">
                    <form action="banner_update_form_action.php" method="post" enctype="multipart/form-data" >
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                <input type="text" class="form-control " name="title" value="<?php if($title!=""){echo $title;}?>">
                                </div>

                                <div class="col-md-12 form-group">
                                <input type="text" class="form-control " name="subtitle" value="<?php if($subtitle!=""){echo $subtitle;}?>">
                                </div>

                                <div class="col-md-12 form-group">
                                <input type="test" class="form-control" name="status" value="<?php if($status!=""){echo $status;}?>">
                                </div>                                
